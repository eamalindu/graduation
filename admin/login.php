    ...
    <div class="panel__inner">
      <form method="POST" autocomplete="off">
        ...
        <div class="field-group">
          ...
          <input type="text" id="username" name="username" class="field-input field-input--text" autocomplete="username" required>
        </div>

        <div class="field-group" style="margin-top: 10px">
          <label for="password" class="field-label">Password</label>
          <input type="password" id="password" name="password" class="field-input field-input--text" autocomplete="current-password" required>
        </div>
